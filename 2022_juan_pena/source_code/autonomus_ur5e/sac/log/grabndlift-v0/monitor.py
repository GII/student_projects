...
def plot_results(log_folder, title='Curva de aprendizaje de experimento 3'):
    """
    plot the results
    ...
    x2, y2 = ts2xy(load_results("/home/juan/tfm_ws/src/autonomus_ur5e/sac/log/grabndlift-v1"), 'timesteps')
