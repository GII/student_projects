...
register(
        id='Ur5eReach-v3',
        entry_point='ur5e_gym.reach_task_v3:Ur5ePick',
...
class Ur5ePick(Ur5eEnv):
    def __init__(self):
        ...
        self.action_space = spaces.Box(low=np.array([0.0,-0.375,0.0]),
                             high=np.array([0.75,0.375,0.75]), dtype=np.float32)
        ...
        self.acceptable_distance_to_ball = 0.08
    ...
    def _set_action(self, action):
        ...
        """ 
        __actions = np.array(action,dtype=np.float64)     
    ...
    def _compute_reward(self, observations, done):
        ...
        reward = distance_reward + error_reward
